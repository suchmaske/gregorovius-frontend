  ...
  <q-page padding>
      ...
      <div class="col-md-8 col-12 q-py-xl q-gutter-y-lg">
        <q-card class="q-pa-xl" flat>
          <q-card-section>
            ...
            >
              <v-runtime-template v-show="showTitle" :template="title" />
            </transition>
    ...
    <div class="row justify-center">
      <div class="col-md-8 col-12 q-pb-xl q-gutter-y-lg">
        <MentionsTable :entity-id="this.$route.params.id" entity-name="Dieser Titel" />
      </div>
    </div>
  </q-page>
</template>
...
export default {
  ...
  created() {
    this.getItems(), this.getXSLT("WorkTitle", "title");
  },
