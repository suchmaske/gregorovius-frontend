          ...
          <q-card class="q-pa-xl" flat>
            ...
            <q-tab-panels v-model="tab" animated>
                ...
                <div class="text-body1">
                  <p>
                    ...
                    <figure class="row justify-center">
                      ...
                      <figcaption class="text-caption">Rom aus dem Garten der Colonna, Bleistift-Zeichnung von F. Gregorovius, BSB München, Nachlass F. Gregorovius, Gregoroviusiana 11, Blatt 39</figcaption>
                    </figure>
                  <p>
                  ...
                  <p class="text-bold">
                    Der aktuelle Stand der Arbeit an den Texten und Datensätzen wird als Betaversion präsentiert, die in regelmäßigen Abständen aktualisiert wird.
                  </p>
                  <p>
                    Das auf eine Laufzeit von vier Jahren angelegte Projekt des Deutschen Historischen Instituts in Rom wird seit 2017 von der Deutschen Forschungsgemeinschaft (DFG) gefördert. Die digitale Erarbeitung der Briefe findet in Zusammenarbeit mit der Berlin-Brandenburgischen Akademie der Wissenschaften statt. Zudem wird das Projekt seit 2018 für die Dauer von drei Jahren von der Gerda Henkel Stiftung großzügig unterstützt.
                  </p>
                  <p>
                    Von Dr. Wiebke Fastenrath-Vinattieri stammen Rohtranskriptionen und erste Kommentargrundlagen der Briefe von Gregorovius an Aleardo Aleardi, Michele Amari, Emilia Viola Ferretti, Raffaele Mariano (21.7.1873 bis 8.12.1877 und 30.11.1879), Oreste Tommasini, Tommaso Gar und an Gustavo Strafforello. Frederike Neuber verantwortet die Textherstellung und die Kommentare dieser Briefe. Die Rohtranskriptionen der Briefe von Gregorovius an Angelo de Gubernatis, Giuseppe De Leva, Ferdinand Martini, Francesco Protonotari und an Filippo Zamboni erstellte ebenfalls Dr. Wiebke Fastenrath-Vinattieri. Eric Müller hat als wissenschaftliche Hilfskraft wesentliche, die Edition vorbereitende Arbeiten übernommen.
                  </p>
                </div>
              </q-tab-panel>
              <q-tab-panel name="tec">
                <div class="text-body1">
                  <p>
                    Die Dateneingabe erfolgt in Oxygen mit Hilfe von <a href="http://www.bbaw.de/telota/software/ediarum">ediarum</a>. Das ediarum.BASE-Framework wurde durch ein Addon ergänzt. Es wird laufend weiterentwickelt und ermöglicht, komplexe projektspezifische Datenstrukturen über eine benutzerfreundliche und für die Briefedition maßgeschneiderte Softwarelösung einzugeben. Das TEI XML Datenmodell der Edition basiert zum Teil auf dem <a href="http://www.deutschestextarchiv.de/doku/basisformat/">Basisformat des Deutschen Textarchivs (DTABf)</a>, ein von der DFG empfohlener datentechnischer Standard. Die vorliegende Web-App wurde auf Frontend-Ebene mit <a href="https://vuejs.org/">Vue.js</a> und <a href="https://quasar.dev/">Quasar</a> gebaut. Die Daten werden in <a href="https://exist-db.org/">eXist-db</a> gehalten und über ein Python-basiertes Backend als REST-Schnittstelle ausgegeben. Die Schnittstelle ist im OpenAPI-Format <a href="http://gregorovius-edition.dhi-roma.it/api/docs">dokumentiert</a> und steht interessierten NutzerInnen und EntwicklerInnen als Webservice zur Verfügung.
                  </p>
                </div>
              </q-tab-panel>
            </q-tab-panels>
